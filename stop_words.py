stop_words = [
    "0o", "0s", "3a", "3b", "3d", "6b", "6o", "a", "a1", "a2", "a3", "a4", "able", "about", "above", "abst", "ac",
    ...
    "b", "b1", "b2", "b3", "ba", "bc", "bd", "be", "became", "because", "become", "becomes", "becoming", "been",
    ...
    "dx", "dy", "e", "e2", "e3", "ea", "each", "ec", "ed", "edu", "ee", "ef", "effect", "eg", "ei",
    "either", "ej", "el", "else", "elsewhere", "em", "empty", "en", "end", "ending", "enough", "entirely",
    ...
    "far", "fc", "few", "ff", "fi", "fify", "fill", "find", "fire", "fix", "fj",
    "fl", "fn", "fo", "followed", "following", "follows", "for", "former", "formerly", "found",
    "fr", "from", "front", "fs", "ft", "fu", "further", "furthermore", "fy", "g", "ga", "gave", "ge",
    "get", "gets", "getting", "gi", "give", "given", "gives", "giving", "gj", "gl", "go", "goes", "going", "gone",
    "got", "gotten", "gr", "greetings", "gs", "gy", "h", "h2", "h3", "had", "hadn", "hadn't", "happens", "hardly",
    "has", "hasn", "hasnt", "hasn't", "have", "haven", "haven't", "having", "he", "hed", "he'd", "he'll", "hello",
    ...
    "howbeit", "however", "how's", "hr", "hs", "http", "hu", "hy", "i", "i2", "i3", "i4", "i6", "i7", "i8",
    ...
    "merely", "mg", "might", "mightn", "mightn't", "mill", "mine", "miss", "ml", "mn", "mo", "more",
    ...
    "nj", "nl", "nn", "no", "nobody", "non", "none", "nonetheless", "noone", "nor", "normally", "nos",
    "not", "noted", "nothing", "novel", "now", "nowhere", "nr", "ns", "nt", "ny", "o", "oa", "ob", "obtain", "obtained",
    "obviously", "oc", "od", "of", "off", "often", "og", "oh", "oi", "oj", "ok", "okay", "ol", "old", "om", "omitted",
    "on", "once", "ones", "only", "onto", "oo", "op", "oq", "or", "ord", "os", "ot", "other", "others",
    "otherwise", "ou", "ought", "our", "ours", "ourselves", "out", "outside", "over", "overall", "ow", "owing", "own",
    "ox", "oz", "p", "p1", "p2", "p3", "page", "pagecount", "pages", "par", "part", "particular", "particularly",
    "pas", "past", "pc", "pd", "pe", "per", "perhaps", "pf", "ph", "pi", "pj", "pk", "pl", "placed", "please", "plus",
    "pm", "pn", "po", "poorly", "possible", "possibly", "potentially", "pp", "pq", "pr", "predominantly", "present",
    "presumably", "previously", "primarily", "probably", "promptly", "proud", "provides", "ps", "pt", "pu", "put", "py",
    "q", "qj", "qu", "que", "quickly", "quite", "qv", "r", "r2", "ra", "ran", "rather", "rc", "rd", "re", "readily",
    "really", "reasonably", "recent", "recently", "ref", "refs", "regarding", "regardless", "regards", "related",
    "relatively", "research", "research-articl", "respectively", "resulted", "resulting", "results", "rf", "rh", "ri",
    "right", "rj", "rl", "rm", "rn", "ro", "rq", "rr", "rs", "rt", "ru", "run", "rv", "ry", "s", "s2", "sa", "said",
    "same", "saw", "say", "saying", "says", "sc", "sd", "se", "sec", "secondly", "section", "see", "seeing",
    ...
    "significantly", "similar", "similarly", "since", "sincere", "sj", "sl", "slightly", "sm", "sn",
    ...
    "this", "thorough", "thoroughly", "those", "thou", "though", "thoughh", "thousand", "throug", "through",
    ...
    "twice", "tx", "u", "u201d", "ue", "ui", "uj", "uk", "um", "un", "under",
